...
export function ForumCreateTopicPage() {
  ...
  return (
    <>
      <Card title="Create New Topic" style={{ color: COLORS.WHITE }}>
        <Form layout="vertical" onFinish={onFinish}>
          <Form.Item
            label={<span style={{ color: COLORS.WHITE }}>Title</span>}
            name="title"
          ...
          <Form.Item
            label={<span style={{ color: COLORS.WHITE }}>Description</span>}
            name="description"
